...
def run_tuning(args, tuning_dataset):
    ...
    # '''
    command = f'/gpu-work/gp9000/gp0900/next/anaconda3/envs/cuda11/bin/python ./tuning.py {generate_command(args)} --tuning_dataset {tuning_dataset}'
...
if __name__ == '__main__':
    ...
    if args.tuning_dataset is not None:
        tunining_dataset_list = [args.tuning_dataset]
