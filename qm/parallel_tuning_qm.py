...
from tuning_reg import TokenMAEClf
...
def run_tuning(args, tuning_dataset):
    ...
    # '''
    command = f'python ./tuning_qm.py {generate_command(args)} --tuning_dataset {tuning_dataset}'
...
if __name__ == '__main__':
    ...
    # tunining_dataset_list = ['esol', 'lipophilicity', 'malaria', 'cep']
    tunining_dataset_list = ['qm7','qm8','qm9']
